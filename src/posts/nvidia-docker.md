...
pubDate: "2026-09-09"
excerpt: "Recently noticed that my nvidia gpu wasn't being used by plex hardware transcoding despite having the driver correctly installed and passed through as normal. After attempting to debug this for a while and throwing an llm at it to no joy, I found a fix..."
---
